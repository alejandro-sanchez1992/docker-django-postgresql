...
INSTALLED_APPS = [
    ...
    'apps',
    'apps.web',                                    # Enable the inner web (home)
    'allauth',                                      # OAuth new
...
LOGOUT_REDIRECT_URL = "home"  # Route defined in web/urls.py
...
elif os.environ.get('DB_ENGINE') and os.environ.get('DB_ENGINE') == "postgresql":
    DATABASES = { 
        'default': {
            'ENGINE'  : 'django.db.backends.postgresql_psycopg2', 
            'NAME'    : os.getenv('DB_NAME'     , 'appseed_db'),
            'USER'    : os.getenv('DB_USERNAME' , 'alejandrosanchez'),
